...
namespace Cursach
{
    ...
    public partial class Settings : Window
    {
        ...
        static void Method(ref string i)
        {
         ...
         private void butBrowse_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == true)
            {
              ...
              //  System.IO.FileInfo file = new System.IO.FileInfo(Path.GetDirectoryName(dlg.FileName) + @"\" + filename);
               ...
               string sizefunc = GetFileSize(new System.IO.FileInfo(dlg.FileName));
       ...
       public void SavePrompt(string fileName)
        {
            ...
            Dispatcher.BeginInvoke(new Action(() =>
            {
                ...
                MessageBoxResult result = MessageBox.Show("Принять файл: " + fileName + "?"+"\n"+" Размер файла:"+ size , "Сообщение", MessageBoxButton.YesNo, MessageBoxImage.Question);
